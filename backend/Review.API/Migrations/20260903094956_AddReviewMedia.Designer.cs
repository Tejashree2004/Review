...
namespace Review.API.Migrations
{
    ...
    [Migration("20260903094956_AddReviewMedia")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Review.API.Models.EmailOtp", b =>
                {
                    b.Property<int>("EmailOtpId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("EmailOtpId"));
            ...
            modelBuilder.Entity("Review.API.Models.ReviewMedia", b =>
                {
                    b.Property<int>("ReviewMediaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("ReviewMediaId"));
            ...
            modelBuilder.Entity("Review.API.Models.ReviewMedia", b =>
                {
                    b.HasOne("Review.API.Models.ReviewItem", "Review")
                        .WithMany("Media")
